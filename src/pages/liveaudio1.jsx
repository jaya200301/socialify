...
import Prof from "../assets/liveprof.jpg";
        ...
        <div className="bg-[#20043F] text-white">
            ...
            <div>
                ...
                <div className="w-full h-auto absolute top-[23%] flex flex-col items-center justify-center text-white">
                    <img src={Prof} alt="" className=" w-[300px] h-auto rounded-[50%] mb-3" />
                    ...
                    <div className="mt-[32px] w-[30%] flex flex-row items-center justify-center gap-3">
                        <button onClick={() => navigate('/liveaudio2')} className="w-full h-auto bg-[#ffbe3f] font-medium py-2 rounded-[10px] text-black">Gabung</button>
