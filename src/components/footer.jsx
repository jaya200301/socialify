...
import Tag from "../assets/Socialify.png";
import CR from "../assets/Copyright.png";
import Conn from "../assets/Connect.png";
import Mail from "../assets/Letter.png";
import FB from "../assets/Facebook.png";
import LI from "../assets/LinkedIn.png";
import IG from "../assets/Instagram.png";
import TW from "../assets/Twitter.png";
import GP from "../assets/gplay.png";

function Footer() {
    return (
        <div className="w-full h-auto bg-[#222227] flex flex-col items-center justify-center text-[#F5F1FB] text-center py-14">
            ...
            <img src={CR} alt="" className="w-[450px] h-auto mt-[60px]" />
        </div>
    )
}
